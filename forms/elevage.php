                        ...
                        <?php
                            ...
                            <?php foreach ($results as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="elevage-edit.php?id=<?= $row['codeactivite'] ?>"><button name="edit_elevage" class="edit-btn btn btn-warning" data-id="<?= $row['codeactivite'] ?>">Editer</button></a>
                                    </td>
                                    <td>
                                        <button name="delete_elevage" class="delete-btn btn btn-danger" data-id="<?= $row['codeactivite'] ?>" onclick="return confirm('Etes vous d\'effacer cette ligne?');">Effacer</button>
                                    </td>
                                </tr>
                        <?php endforeach; ?>
                    </tbody>
