                        ...
                        <?php if (isset($_GET['message'])) { ?>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="tel" value="<?=$result->telephone; ?>" class="form-control" name="telephone" id="telephone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-456-7890">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="fax">Fax_Partenaire </label>
                                    <input type="tel" value="<?=$result->fax; ?>" class="form-control" id="fax" name="fax" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-456-7890">
                                </div>
                                <div class="form-group col-md-6">
